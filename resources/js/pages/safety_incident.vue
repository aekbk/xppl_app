            ...
            <div class="gap-2 d-sm-flex">
              <div class="input-group" style="width: 300px">
                <input
                  ...
                  v-model="value"
                  @input="getIncident('Month')"
                />
                <input
                  type="text"
                  id="mode-3"
                  class="form-control flatpickr-input flatpickr-range rounded-start-2 cursor-pointer d-none"
                  placeholder="Select date range"
                  aria-label="Text input with dropdown button"
                  v-model="value"
                  @input="getIncidentRange"
                />
              ...
              >
                <li>
                  <a
                    ...
                    @click="newIncident"
                    ><i
                      class="ri-add-circle-fill align-bottom me-2 text-muted"
                    ></i
                    >Add</a
                  >
                </li>
      ...
      <div v-else>
        <div class="custom-grid p-3">
          <ag-grid-vue
            ...
            @cell-double-clicked="viewIncident"
          ></ag-grid-vue>
        </div>
      </div>
    </div>
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="mt-xl-4 mt-4">
                      ...
                      <p class="mb-1">
                        ...
                        >{{ store.dateTime2(incForm.date_time) }}
                      </p>
                      <p class="mb-1">
                      ...
                      <p v-if="incForm.company == 'XPPL'" class="mb-1">
                  ...
                  <div class="flex-shrink-0 mt-xl-0 mt-3">
                    <h4>
                      <span class="text-muted text-uppercase fw-semibold"
                        >Incident No: {{ incForm.incident_no }}</span
                      >
                    </h4>
                    <h6>
                      <span class="text-muted fw-normal">Incident ID: </span
                      ><span>{{ incForm.incident_id }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Significant: </span
                      ><span>{{ incForm.significant }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Flash Alert: </span
                      ><span> {{ incForm.flash_alert }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Actaul Severity: </span
                      ><span>{{
                        store.severity(incForm.actual_severity)
                      }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal"
                        >Potential Severity: </span
                      ><span>
                        {{ store.severity(incForm.potential_severity) }}</span
                      >
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Risk Rating: </span>
                      <span
                        v-if="Number(incForm.risk_rating) <= 3"
                        class="badge text-white fs-12"
                        style="background-color: #3ab249"
                      >
                        {{ incForm.risk_rating }} (Low)</span
                      >
                      <span
                        v-if="
                          Number(incForm.actual_severity) == 2 &&
                          Number(incForm.potential_severity) == 2
                        "
                        class="badge text-white fs-12"
                        style="background-color: #3ab249"
                      >
                      ...
                      <span
                        v-if="
                          Number(incForm.actual_severity) !==
                            Number(incForm.potential_severity) &&
                          Number(incForm.risk_rating) == 4
                        "
                        class="badge text-white fs-12"
                        style="background-color: #f7ec0f"
                      >
                        {{ incForm.risk_rating }} (Medium)</span
                      >
                      <span
                        v-if="
                          Number(incForm.risk_rating) >= 5 &&
                          Number(incForm.risk_rating) <= 9
                        "
                        class="badge text-primary fs-12"
                        style="background-color: #f7ec0f"
                      >
                        {{ incForm.risk_rating }} (Medium)</span
                      >
                      <span
                        v-if="
                          Number(incForm.risk_rating) >= 10 &&
                          Number(incForm.risk_rating) <= 12
                        "
                        class="badge text-white fs-12"
                        style="background-color: #f89122"
                      >
                        {{ incForm.risk_rating }} (High)</span
                      >
                      <span
                        v-if="Number(incForm.risk_rating) > 12"
                        class="badge text-white fs-12"
                        style="background-color: #e52125"
                      >
                        {{ incForm.risk_rating }} (Very High)</span
                      >
                    </h6>
                  </div>
                </div>
              ...
              <div class="card-header p-4 border-0">
                <div class="d-xl-flex">
                  <div class="flex-grow-1">
                    ...
                    <p class="mb-1">
                      <span class="text-muted">Incident Group: </span
                      >{{ incForm.incident_group }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Incident Type: </span
                      >{{ incForm.incident_type }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Injury Type: </span
                      >{{ incForm.incident_type }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Injury Group: </span
                      >{{ incForm.injury_group }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Injury Body Paart: </span
                      >{{ incForm.injury_part }}
                    </p>
                  </div>
                  <div class="flex-shrink-0 mt-xl-0 mt-3">
                    ...
                    <p class="mb-1">
                      <span class="text-muted">Investigate Status: </span
                      >{{ incForm.invest_status }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Investigate Lead By: </span
                      >{{ incForm.invest_lead }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Action Status: </span
                      >{{ incForm.action_status }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Action Due Date: </span
                      >{{ store.ddmmyyyy(incForm.action_duedate) }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Incident Manager: </span
                      >{{ incForm.incident_manager }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Follow Up By: </span
                      >{{ incForm.followup_by }}
                    </p>
                  </div>
                </div>
            ...
            <div class="col-lg-12">
              ...
              >
                ...
                <div class="table-responsive border">
                  <table
                    class="table align-middle table-borderless table-nowrap mb-0 table-sm"
                  >
                ...
                <div class="card-body p-4 pt-0">
                  <div class="hstack gap-2 justify-content-end d-print-none">
                    ...
                    <a
                      href="javascript:void(0);"
                      class="btn btn-info"
                      @click="(viewMode = 'main'), editIncident()"
              ...
              <div class="tab-pane active show" id="incident" role="tabpanel">
                <div class="row">
                  <div class="col-xl-2 col-lg-3">
                    <div class="mb-3">
                      <label class="form-label"
                        >Incident No. <span class="text-danger">*</span></label
                      >
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Incident number"
                        v-model="incForm.incident_no"
                      />
                    </div>
                  </div>
                  <div class="col-xl-2 col-lg-3">
                  ...
                  <div class="col-xl-8 col-lg-6">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        v-model="incForm.incident_title"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <multiselect
                        ...
                        :searchStart="false"
                        :options="lkCompany"
                        v-model="incForm.company"
                        @select="incForm.department = ''"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                  ...
                  <div class="col-xl-2 col-lg-4">
                    <div class="mb-3">
                      <label class="form-label"
                        >Significant <span class="text-danger">*</span></label
                      >
                      <multiselect
                        placeholder="Select"
                        :searchable="false"
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      >
                      <multiselect
                        placeholder="Select incident group"
                        :searchable="true"
                        :searchStart="true"
                        :options="lkIncGroup"
                        v-model="incForm.incident_group"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      <label class="form-label"
                        >Injury Group <span class="text-danger">*</span></label
                      >
                      <multiselect
                        placeholder="Select injury group"
                        :searchable="true"
                        :searchStart="true"
                        :options="lkInjGroup"
                        v-model="incForm.injury_group"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Enter injury body part"
                        v-model="incForm.injury_part"
                      />
                    </div>
                  </div>
                  ...
                  <div class="col-xl-2 col-lg-4">
                    <div class="mb-3">
                      ...
                      <multiselect
                        ...
                        :searchStart="true"
                        :options="lkActualSev"
                        v-model="incForm.actual_severity"
                      />
                    </div>
                  </div>
                  <div class="col-xl-2 col-lg-4">
                    <div class="mb-3">
                      ...
                      <multiselect
                        ...
                        :searchable="false"
                        :searchStart="true"
                        :options="lkPotentialSev"
                        v-model="incForm.potential_severity"
                      />
                    </div>
                  </div>
                  <div class="col-xl-2 col-lg-3">
                  ...
                  <div class="col-lg-3">
                    <div class="mb-3">
                      <label class="form-label"
                        >Invest Status <span class="text-danger">*</span></label
                      >
                      <multiselect
                        placeholder="Select status"
                        :searchable="false"
                        :searchStart="true"
                        :options="lkInvestStatus"
                        v-model="incForm.invest_status"
                      />
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Enter invest lead name"
                        v-model="incForm.invest_lead"
                      />
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="mb-3 mb-lg-0">
                      <label class="form-label"
                        >Action Status <span class="text-danger">*</span></label
                      >
                      <multiselect
                        placeholder="Select action status"
                        :searchable="false"
                        :searchStart="true"
                        :options="lkActionStatus"
                        v-model="incForm.action_status"
                      />
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="mb-3 mb-lg-0">
                      ...
                      <input
                        type="text"
                        id="due-date"
                        class="form-control cursor-pointer flatpickr-input flatpickr-single"
                        placeholder="Enter action due date"
                        v-model="incForm.action_duedate"
                      />
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="mb-3 mb-lg-0">
                      ...
                      <input
                        ...
                        v-model="incForm.incident_manager"
                      />
                    </div>
                  </div>
              ...
              <div class="tab-pane" id="description" role="tabpanel">
                <div class="col-12">
                  ...
                  <textarea
                    class="form-control"
                    rows="12"
                    placeholder="Enter nncident description"
                    v-model="incForm.incident_descr"
                  ></textarea>
                </div>
              </div>
              ...
              <div class="tab-pane" id="corrective" role="tabpanel">
                <div class="col-12">
                  ...
                  <textarea
                    ...
                    v-model="incForm.corrective_action"
                  ></textarea>
                </div>
              </div>
          ...
          <div class="modal-body text-center p-5">
            ...
            <div class="text-center">
              ...
              <div class="hstack gap-2 justify-content-center remove">
                ...
                <button class="btn btn-soft-danger" @click="delConfirm">
                  Yes, Delete It
                </button>
              </div>
            </div>
...
export default {
      ...
      columnDefs: [
        {
          ...
          cellStyle: (p) => {
            if (Number(p.data.risk_rating) <= 3) {
              ...
              Number(p.data.actual_severity) == 2 &&
              Number(p.data.potential_severity) == 2
            ) {
              return { backgroundColor: "#3AB249", "text-align": "center" };
            } else if (
              Number(p.data.actual_severity) !==
                Number(p.data.potential_severity) &&
              Number(p.data.risk_rating) == 4
            ) {
              return { backgroundColor: "#F7EC0F", "text-align": "center" };
            } else if (
              Number(p.data.risk_rating) >= 5 &&
              Number(p.data.risk_rating) <= 9
            ) {
              return { backgroundColor: "#F7EC0F", "text-align": "center" };
            } else if (
              Number(p.data.risk_rating) >= 10 &&
              Number(p.data.risk_rating) <= 12
            ) {
        ...
        },
        {
          ...
          maxWidth: 100,
          filter: "agSetColumnFilter",
          valueGetter: (p) => Number(p.data.incident_no),
        },
        {
        ...
        {
          headerName: "Incident Group",
          field: "incident_group",
          filter: "agSetColumnFilter",
        },
        {
        ...
        {
          headerName: "Injury Group",
          field: "injury_group",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Injury Body Part",
          field: "injury_part",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Actual Severity",
          field: "actual_severity",
          filter: "agSetColumnFilter",
          valueGetter: (p) => Number(p.data.actual_severity),
        },
        {
          headerName: "Potential Severity",
          field: "potential_severity",
          filter: "agSetColumnFilter",
          valueGetter: (p) => Number(p.data.potential_severity),
        },
        {
          headerName: "Risk Rating",
          field: "risk_rating",
          filter: "agSetColumnFilter",
          valueGetter: (p) => Number(p.data.risk_rating),
        },
        {
          headerName: "Invest Status",
          field: "invest_status",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Invest Lead",
          field: "invest_lead",
          filter: "agSetColumnFilter",
        },
        {
        ...
        {
          headerName: "Action Due Date",
          field: "action_duedate",
          valueFormatter: (p) =>
            p.value ? moment(p.value).format("DD-MM-YYYY") : "",
        },
        {
          headerName: "Incident Manager",
          field: "incident_manager",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Followup By",
          field: "followup_by",
          filter: "agSetColumnFilter",
        },
  ...
  computed: {
    ...
    riskRatingCalc() {
      ...
      if (f.actual_severity && f.potential_severity) {
        f.risk_rating =
          Number(f.actual_severity) * Number(f.potential_severity);
      } else {
        f.risk_rating = "";
      }
    },
  ...
  methods: {
    async onLoad() {
      ...
      const year = await axios.get("api/safety/years", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
      ...
      const codes = await axios.get("api/safety/codes", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
      const category = [
      ...
      for (let j = 0; j < category.length; j++) {
        ...
        let item = codes.data.filter(
          (e) => e.category == [cateName] && e.active == 1
        );
        this[lkName] = [];
      ...
      // Department Code
      const depts = await axios.get("/api/safety/departments", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
    ...
    async getFile() {
      const response = await axios.get("/api/safety/incident-files", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
    ...
    async getIncident(mode) {
      ...
      const response = await axios.get(
        `api/safety/incidents?requestValue=${this.value}&requestMode=${mode}`,
        { headers: { Authorization: "Bearer " + this.authStore.getToken } }
      );
    ...
    async getIncidentRange() {
      ...
      if (this.value && this.value.length > 12) {
        ...
        const result = await axios.get(
          `api/safety/incidents?dateFr=${dateFr}&dateTo=${dateTo}`,
          { headers: { Authorization: "Bearer " + this.authStore.getToken } }
        );
    ...
    async newIncident() {
      if (this.auth.new == 0) {
        ...
        this.actMode = "add";
        const lastNo = await axios.get("/api/safety/incident-nextno", {
          headers: { Authorization: "Bearer " + this.authStore.getToken },
        });
    ...
    async addIncident() {
      ...
      f.incident_manager
        ? fd.append("incident_manager", f.incident_manager)
        : "";
      f.followup_by ? fd.append("followup_by", f.followup_by) : "";
      f.corrective_action
        ? fd.append("corrective_action", f.corrective_action)
        : "";

      const response = await axios.post("api/safety/add-incident", fd, {
        headers: {
    ...
    async updIncident() {
      ...
      try {
        const response = await axios.post("api/safety/upd-incident", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: "Bearer " + this.authStore.getToken,
          },
      ...
      if (this.auth.del == 0) {
        ...
        this.$swal
          .fire({
            ...
            confirmButtonText:
              '<i class="fe fe-trash-2"></i> <span class="fs-14 fw-light">Delete</span>',
            cancelButtonText:
              '<i class="fe fe-x"></i> <span class="fs-14 fw-light">Cancel</span>',
    ...
    cellCicked(e) {
      ...
      let file = this.files.filter(
        (e) => e.incident_id == this.incForm.incident_id
      );
    ...
    viewFile(file) {
      window.open(
        window.location.origin + "/assets/images/incidents/" + file,
        "_blank"
      );
    },
