          ...
          <div v-else>
              ...
              <div class="col-xxl-6">
                <div class="d-flex flex-column h-100">
                  <div class="row">
                    ...
                    <!-- <div class="col-lg-6">
                      <div class="card card-animate bg-gradient bg-warning bg-opacity-50">
                        <div class="card-body">
                          <div class="d-flex align-items-center">
                            <div class="flex-grow-1 overflow-hidden">
                          ...
                          <div class="d-flex align-items-end justify-content-between align-items-baseline">
                            <h4 class="fs-22 fw-semibold ff-secondary mb-0">{{ store.numInt(dash1Data[4].ton) }}<span class="text-muted fw-normal fs-13 ms-1">ton</span></h4>
                            <p class="mb-0 text-truncate ms-1 text-secondary fw-medium">{{ store.numDec(dash1Data[4].ton * 100 / 4500000) }}%</p>
                          </div>
                        </div>
                      </div>
                    </div> -->
            ...
            <div class="col-xl-12">
              <div class="card">
                ...
                <ag-grid-vue style="height: 340px" class="ag-theme-material" :columnDefs="columnDefs" :rowData="filtered" :defaultColDef="defaultColDef" :rowHeight="30" :headerHeight="31.99" :suppressMenuHide="false" :suppressCellFocus="true" animateRows="false" rowSelection="single"></ag-grid-vue>
                <div class="pb-2"></div>
              </div>
            </div>
  ...
  methods: {
    ...
    async getDashboards() {
      try {
        ...
        let item = this.dash2Data.filter((e) => e.contract_status == 'Active');
        this.filtered = item;
