      ...
      <div class="card" id="main" v-if="viewMode == 'main'">
            ...
            <div class="col-sm-auto ms-auto">
              <div class="hstack gap-2">
                <button
                  ...
                  @click="newContract()"
                >
                  <i class="ri-add-line align-bottom me-1"></i> Add Contract
                </button>
                <button
                ...
                >
                  ...
                  <li>
                    <a
                      ...
                      href="javascript:void(0);"
                      @click="orderOpen()"
                      ><i class="ri-todo-fill align-bottom me-2 text-muted"></i
                      >Orders</a
                    >
                  </li>
                  <li>
                    <a
                      ...
                      ><i
                        class="ri-attachment-line align-bottom me-2 text-muted"
                      ></i
                      >Attachments</a
                    >
                  </li>
        ...
        <div class="custom-grid p-3">
          <ag-grid-vue
            ...
            @cell-double-clicked="viewContract"
          ></ag-grid-vue>
        </div>
      </div>
    </div>
              ...
              <div class="card-header border-bottom-dashed p-4">
                <div class="d-xl-flex">
                  <div class="flex-grow-1">
                    <h5 class="text-uppercase fw-semibold">
                      {{ customerFilter.customer_name }}
                    </h5>
                    <div class="mt-xl-4 mt-4">
                      ...
                      <p class="mb-1">
                        ...
                        >{{ customerFilter.country }}
                      </p>
                      <p class="mb-1">
                        <span class="text-muted">Destination: </span
                        >{{ customerFilter.destination }}
                      </p>
                  ...
                  <div class="flex-shrink-0 mt-xl-0 mt-3">
                    ...
                    <h6>
                      <span class="text-muted fw-normal">Customer Code: </span
                      ><span>{{ customerFilter.customer_code }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Tax Code: </span
                      ><span> {{ customerFilter.tax_code }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Email: </span
                      ><span>{{ customerFilter.email }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Contact: </span
                      ><span> {{ customerFilter.contract }}</span>
                    </h6>
                    <h6>
                      <span class="text-muted fw-normal">Contact No: </span
                      ><span> {{ customerFilter.phone }}</span>
                    </h6>
                  </div>
                </div>
              </div>
                ...
                <div class="d-xl-flex">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <p class="mb-1">
                          ...
                          >{{ customerFilter.contract_no }}
                        </p>
                        <p class="mb-1">
                          <span class="text-muted">Appendix: </span
                          >{{ customerFilter.appendix }}
                        </p>
                        <p class="mb-1">
                          <span class="text-muted">Signed Date: </span
                          >{{ store.fullMonth(customerFilter.signed_date) }}
                        </p>
                      </div>
                      <div class="col-12">
                        <p class="mb-1">
                          <span class="text-muted">Loading Place: </span
                          >{{ customerFilter.loading_place }}
                        </p>
                        <p class="mb-1">
                          <span class="text-muted">Delivery Place: </span
                          >{{ customerFilter.delivery_place }}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="flex-shrink-0 mt-xl-0 mt-3">
                    <p class="mb-1">
                      ...
                      >{{ store.numInt(customerFilter.contract_quantity) }} T
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Grade: </span
                      >{{ customerFilter.contract_grade_name }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Grade GAR: </span
                      >{{ customerFilter.contract_grade_gar }}
                    </p>
                    <p class="mb-1">
                      <span class="text-muted">Status: </span>
                      <span
                        v-if="customerFilter.contract_status == 'Active'"
                        class="badge bg-danger-subtle text-danger fs-14 ms-1"
                        >{{ customerFilter.contract_status }}</span
                      >
                      <span
                        v-else
                        class="badge bg-success-subtle text-success fs-14 me-1"
                        >{{ customerFilter.contract_status }}</span
                      >
                    </p>
                  </div>
            ...
            <div class="col-lg-12">
              <div class="card-body p-4 border-top border-top-dashed">
                ...
                <div class="table-responsive border">
                  <table
                    class="table align-middle table-borderless table-nowrap mb-0"
                  >
              ...
              <div
                class="card-body p-4 border-top border-top-dashed d-print-none"
                v-if="fileFilter.length > 0"
              >
                <h6 class="text-muted text-uppercase fw-semibold">
                  Attachments
                </h6>
                      ...
                      <tr v-for="(item, index) in fileFilter" :key="index">
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <div
                              class="flex-shrink-0 fs-17 me-2 filelist-icon text-secondary"
                            >
                              <i
                                v-if="item.file_type == 'txt'"
                                class="ri-file-text-fill text-info"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'docx'"
                                class="ri-file-word-fill"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'xlsx'"
                                class="ri-file-excel-fill text-success"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'pptx'"
                                class="ri-file-ppt-fill text-danger"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'pdf'"
                                class="ri-file-pdf-fill text-danger"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'jpg'"
                                class="ri-image-2-fill text-success"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'jpeg'"
                                class="ri-image-2-fill text-success"
                              ></i>
                              <i
                                v-else-if="item.file_type == 'png'"
                                class="ri-image-2-fill text-success"
                              ></i>
                              <i
                              ...
                              <i
                                v-else
                                class="ri-file-unknow-fill text-warning"
                              ></i>
                            </div>
                        ...
                        <td>
                          <div class="d-flex gap-2 justify-content-start">
                            <a
                              ...
                              "
                              href="#"
                              class="link-success text-decoration-none fs-14 mt-1"
                              @click="viewFile(item.new_name)"
                              ><i class="ri-eye-line"></i
                            ></a>
                            <a
                              v-else
                              href="#"
                              class="link-success text-decoration-none fs-14 pt-1"
                            ...
                            <a
                              href="#"
                              class="link-success text-decoration-none fs-16"
                              @click="downloadFile(item.new_name)"
                ...
                <div class="card-body p-4 border-top border-top-dashed">
                  <div class="alert alert-info m-0">
                    <p class="mb-0">
                      ...
                      <span id="note">
                        {{ customerFilter.contract_remarks }}
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        v-model="contractForm.contract_no"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        class="form-control flatpickr-input flatpickr-single rounded-start-2"
                        placeholder="Select date"
                        v-model="contractForm.signed_date"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <cleave
                        :options="int"
                        class="form-control"
                        placeholder="Enter quantity ton"
                        v-model="contractForm.contract_quantity"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <multiselect
                        ...
                        :options="lkGrade"
                        v-model="contractForm.contract_grade_id"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        v-model="contractForm.contract_grade_gar"
                        readonly
                      />
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        class="form-control"
                        placeholder="Enter loading place"
                        v-model="contractForm.loading_place"
                      />
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        v-model="contractForm.delivery_place"
                      />
                    </div>
                  </div>
                  <div class="col-lg-8">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        v-model="contractForm.contract_appendix"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-12">
                    ...
                    <textarea
                      ...
                      v-model="contractForm.contract_remark"
                    ></textarea>
                  </div>
                  {{ getGradeGAR2 }}
                </div>
              ...
              <div class="tab-pane active show" id="add-order" role="tabpanel">
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Autofill based on grade"
                        v-model="orderForm.grade_gar"
                        readonly
                      />
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      ...
                      <cleave
                        ...
                        v-model="orderForm.initial_price"
                      />
                    </div>
                  </div>
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <div class="mb-3">
                      <label class="form-label"
                        >VAT Remark <span class="text-danger">*</span></label
                      >
                      <multiselect
                        placeholder="Select VAT remark"
                        :options="lkVat"
                        v-model="orderForm.vat_remark"
                      />
                    </div>
                  </div>
                  <div class="col-lg-8">
                    <div class="mb-3">
                      <label class="form-label"
                        >Price Term <span class="text-danger">*</span></label
                      >
                      <multiselect
                        placeholder="Select price term"
                        :options="lkPriceTerm"
                        v-model="orderForm.price_term"
                      />
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        class="form-control"
                        placeholder="Enter appendix"
                        v-model="orderForm.order_appendix"
                      />
                    </div>
                  </div>
                  <div class="col-lg-8">
              ...
              <div class="tab-pane" id="add-attachment" role="tabpanel">
                ...
                <div class="vstack gap-2">
                  <div
                    ...
                    v-for="(item, index) in fileFilter"
                    :key="index"
                  >
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0 me-3">
                        <div class="avatar-sm">
                          ...
                          >
                            <i
                              v-if="store.fileType(item.file_name) == 'txt'"
                              class="ri-file-text-fill text-info"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'docx'
                              "
                              class="ri-file-word-fill"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'xlsx'
                              "
                              class="ri-file-excel-fill text-success"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'pptx'
                              "
                              class="ri-file-ppt-fill text-danger"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'pdf'
                              "
                              class="ri-file-pdf-fill text-danger"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'jpg'
                              "
                              class="ri-image-fill text-success"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'jpeg'
                              "
                              class="ri-image-fill text-success"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'png'
                              "
                              class="ri-image-fill text-success"
                            ></i>
                            <i
                              v-else-if="
                                store.fileType(item.file_name) == 'zip'
                              "
                              class="ri-folder-zip-line"
                            ></i>
                            <i
                      ...
                      <div class="flex-shrink-0 ms-2">
                        <div class="d-flex gap-1">
                          ...
                          <div v-else>
                            <a
                              href="javascript:void(0);"
                              class="btn btn-soft-success btn-sm btn-icon dropdown"
                              data-bs-toggle="dropdown"
                              aria-expanded="false"
                            >
                            ...
                            >
                              ...
                              >
                                <a
                                  ...
                                  @click="viewFile(item.new_name)"
                                  ><i
                                    class="ri-eye-line me-2 align-bottom text-muted"
                                  ></i
                                  >View</a
                                >
                              </li>
                              ...
                              <li>
                                <a
                                  ...
                                  @click="downloadFile(item.new_name)"
                                  ><i
                                    class="ri-download-2-line me-2 align-bottom text-muted"
                                  ></i
                                  >Download</a
                                >
                              </li>
                              <li>
                                <a
                                  ...
                                  href="javascript:void(0);"
                                  @click="
                                    delFile(item.file_id, item.new_name, index)
                                  "
                                  ><i
                                    class="ri-delete-bin-5-line me-2 align-bottom text-muted"
                                  ></i
                                  >Delete</a
                                >
                              </li>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="mb-3">
                  <label class="form-label"
                    >Contract Number <span class="text-danger">*</span></label
                  >
                  <input
                    type="text"
                    class="form-control"
              ...
              <div class="col-lg-4">
                <div class="mb-3">
                  <label class="form-label"
                    >Total Quantity <span class="text-danger">*</span></label
                  >
                  <cleave
                    :options="int"
                    class="form-control"
          ...
          <div class="modal-body">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table
                  class="table align-middle border table-nowrap mb-0 table-hover cursor-pointer table-sm"
                >
                  <thead class="table-active text-muted">
                    <tr>
                      <th style="width: 30px">#</th>
                  ...
                  <tbody>
                    <tr
                      ...
                      :key="index"
                      @dblclick="editOrder(item.order_id)"
                          ...
                          >
                            <li>
                              <a
                                ...
                                ><i
                                  class="ri-pencil-fill me-2 align-bottom text-muted"
                                ></i
                                >Edit</a
                              >
                            </li>
                            <li>
                              <a
                                class="dropdown-item"
                                href="javascript:void(0);"
                                @click="delOrder(item.order_id, index)"
                                ><i
                  ...
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar-sm">
                      ...
                      >
                        ...
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'docx'"
                          class="ri-file-word-fill"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'xlsx'"
                          class="ri-file-excel-fill text-success"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'pptx'"
                          class="ri-file-ppt-fill text-danger"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'pdf'"
                          class="ri-file-pdf-fill text-danger"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'jpg'"
                          class="ri-image-2-fill text-success"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'jpeg'"
                          class="ri-image-2-fill text-success"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'png'"
                          class="ri-image-2-fill text-success"
                        ></i>
                        <i
                          v-else-if="store.fileType(item.file_name) == 'zip'"
                          class="ri-folder-zip-line"
                        ></i>
...
export default {
  ...
  data() {
    return {
      columnDefs: [
        ...
        {
          headerName: "Grade",
          field: "contract_grade_name",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Grade GAR",
          field: "contract_grade_gar",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Country",
        ...
        },
        {
          ...
          cellRenderer: (p) => {
            if (p.value == "Active") {
              return (
                '<span class="text-danger fw-normal fs-12 py-1 px-2"><i class="ri-checkbox-circle-line fs-13 pe-1"></i>' +
                p.value +
                "</span>"
              );
            } else if (p.value == "Closed") {
              return (
                '<span class="text-success fw-normal fs-12 py-1 px-2"><i class=" ri-close-circle-line fs-13 pe-1"></i>' +
                p.value +
                "</span>"
              );
            } else if (p.value == "Waiting") {
              return (
                '<span class="text-warning fw-normal fs-12 py-1 px-2"><i class="ri-alarm-line fs-13 pe-1"></i>' +
                p.value +
                "</span>"
              );
            }
        ...
        {
          headerName: "Appendix",
          field: "contract_appendix",
          filter: "agSetColumnFilter",
        },
        {
          headerName: "Remarks",
          field: "contract_remarks",
          filter: "agSetColumnFilter",
        },
        {
  ...
  computed: {
    contractList() {
      if (this.search.trim().length > 0) {
        return this.contractData.filter(
          (i) =>
            i.contract_no
              .substring(0, this.search.trim().length)
              .toLowerCase() == this.search.trim().toLowerCase() ||
            i.customer_name
              .substring(0, this.search.trim().length)
              .toLowerCase() == this.search.trim().toLowerCase() ||
            i.contract_status
            ...
            i.destination
              .substring(0, this.search.trim().length)
              .toLowerCase() == this.search.trim().toLowerCase() ||
            i.country.substring(0, this.search.trim().length).toLowerCase() ==
    ...
    getGradeGAR() {
      if (this.orderForm.grade_id) {
        let g = this.gradeData.find(
          (e) => e.grade_id == this.orderForm.grade_id
        );
    ...
    getGradeGAR2() {
      if (this.contractForm.contract_grade_id) {
        let g = this.gradeData.find(
          (e) => e.grade_id == this.contractForm.contract_grade_id
        );
        this.contractForm.contract_grade_gar = g.grade_gar;
      } else {
        this.contractForm.contract_grade_gar = "";
    ...
    addContractDis() {
      ...
      if (
        ...
        fc.contract_no == "" ||
        fc.signed_date == "" ||
        fc.contract_quantity == "" ||
        fc.contract_grade_id == null ||
        fc.contract_status == null ||
        fr.order_date == "" ||
        fr.grade_id == null ||
        fr.vat_remark == null ||
        fr.price_term == null ||
        fr.order_status == null
      ) {
        return "disabled";
      } else {
        return "";
    ...
    editContractDis() {
      ...
      if (
        ...
        f.signed_date == "" ||
        f.contract_quantity == "" ||
        f.contract_grade_id == null ||
        f.contract_status == null
      ) {
        return "disabled";
      } else {
        return "";
    ...
    addOrderDis() {
      if (
        ...
        this.orderForm.grade_id == null ||
        this.orderForm.vat_remark == null ||
        this.orderForm.price_term == null ||
  ...
  methods: {
    async onLoad() {
      ...
      const subData = await axios.get(`api/auth/auth-action?submenu=${sub}`, {
      ...
      const code = await axios.get("api/sales/codes", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
      ...
      const g = await axios.get("api/sales/grades", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
      ...
      const customers = await axios.get("api/sales/customers", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
    ...
    async getContracts() {
      const contracts = await axios.get("api/sales/contracts", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
    ...
    async getOrders() {
      const orData = await axios.get("api/sales/orders", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
    ...
    async getFiles() {
      const cusfile = await axios.get("api/sales/contract-file", {
        headers: { Authorization: "Bearer " + this.authStore.getToken },
      });
    ...
    newContract() {
      if (this.auth.new == 0) {
        ...
        document
          .getElementById("add-attachment-tab")
    ...
    addContract() {
      ...
      fc.contract_appendix
        ? fd.append("contract_appendix", fc.contract_appendix)
        : "";
      fc.contract_remark
        ? fd.append("contract_remark", fc.contract_remark)
        : "";
      ...
      axios
        .post("api/sales/add-contract", fd, {
          headers: {
    ...
    cellCicked(e) {
      ...
      let orderItems = this.orderData.filter(
        (i) => i.contract_id == e.data.contract_id
      );
      this.orderFilter = orderItems;

      let fileItems = this.fileData.filter(
        (i) => i.contract_id == e.data.contract_id
      );
    ...
    updContract() {
      axios
        .post("api/sales/upd-contract", this.contractForm, {
          headers: { Authorization: "Bearer " + this.authStore.getToken },
        })
        .then((response) => {
      ...
      if (this.auth.del == 0) {
        ...
        this.$swal
          .fire({
            ...
            confirmButtonText:
              '<i class="fe fe-trash-2"></i> <span class="fs-14 fw-light">' +
              this.$t("del-btn") +
              "</span>",
            cancelButtonText:
              '<i class="fe fe-x"></i> <span class="fs-14 fw-light">' +
              this.$t("cancel-btn") +
              "</span>",
    ...
    async addOrder() {
      if (this.auth.new == 0) {
        ...
        if (response.data.success) {
          ...
          let items = this.orderData.filter(
            (e) => e.contract_id == this.contractForm.contract_id
          );
    ...
    async updOrder() {
      if (this.auth.edit == 0) {
        ...
        try {
          const data = await axios.post("api/sales/upd-order", this.orderForm, {
            headers: { Authorization: "Bearer " + this.authStore.getToken },
          });
          toastr.success("Successfully!");
          this.orderForm = {};
    ...
    addAttachment() {
      ...
      axios
        .post("api/sales/add-contract-file", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: "Bearer " + this.authStore.getToken,
          },
    ...
    viewFile(file) {
      window.open(
        window.location.origin + "/assets/images/contracts/" + file,
        "_blank"
      );
    },
    ...
    viewContract() {
      this.viewMode = "view";
      let cusomer = this.contractData.find(
        (e) => e.contract_id == this.contractForm.contract_id
      );
